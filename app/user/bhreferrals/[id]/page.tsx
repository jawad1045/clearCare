    ...
    <div className="min-h-screen bg-muted/30">
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          {/* Submitted By */}
          <Card>
            <SectionHeader icon={UserCheck} title="Submitted By" description="Referring contact" />
            <Separator />
            <CardContent className="pt-4">
              <dl className="space-y-3 text-sm">
                <InfoRow
          ...
          {/* Organization */}
          <Card>
            <SectionHeader icon={Building2} title="Organization" description="Associated company" />
            <Separator />
            <CardContent className="pt-4">
          ...
          <CardContent className="pt-4">
            {referral.pdfReport ? (
              ...
              <p className="text-sm text-muted-foreground italic">
                No result available yet. Check back after your referral is processed.
              </p>
            )}
          </CardContent>
        </Card>
        ...
        {/* Status — read-only */}
        <Card className="mt-4">
          <SectionHeader icon={Activity} title="Referral Status" description="Current state of your referral" />
          <Separator />
          <CardContent className="pt-4">
